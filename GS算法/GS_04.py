...
class WeightedGSAlgorithm:
    ...
    def run(self):
        ...
        for i in range(self.iterations):
            ...
            # 反向传播：焦平面 -> SLM平面
            slm_field = self.backward_propagation(constrained_focal_field)
...
def create_weights(size, traps_positions, weight_value=5.0, background_weight=1.0):
    """
    创建权重矩阵，强调光镊位置的重要性
...
if __name__ == "__main__":
    ...
    # 创建权重矩阵（强调光镊位置）
    weights = create_weights(slm_size, traps_positions, weight_value=10.0)
